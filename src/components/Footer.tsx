...
const compactSocials = socials.slice(0, 6)
...
const Divider = () => (
  <div aria-hidden="true" className="h-[2px] bg-white w-full max-w-[90%] sm:max-w-[600px] md:max-w-[1000px] mx-auto" />
)
            ...
            <div className="pt-12 pb-6 text-sm text-slate-400">
              <div className="max-w-4xl mx-auto grid gap-8 grid-cols-1 md:grid-cols-2 items-start">
                ...
                <div className="grid grid-cols-3 grid-rows-2 gap-y-4 text-center place-items-center">
                  {compactSocials.map((s) => <SocialLink key={s.name} social={s} hovered={hovered} setHovered={setHovered} />)}
                </div>
              </div>
