            ...
            <div className="flex-1 flex flex-col items-center px-6">
                <div className="w-full max-w-4xl rounded-md p-8">
                    <p className="-mt-6 text-md text-white text-center">
                        Hello everyone o// I'm Dikonakaya and I'm a pixel artist, photographer, software developer, and content creator.
                        ...
                        want to say hi, feel free to reach out via the contact page! I hope you're having a wonderful week and take care :D
                    </p>
                                ...
                                {hardSkills.map((s) => (
                                    <div key={s.title} className="p-3 rounded-md bg-black/50 hover:bg-black/70 transition-colors">
                                        <div className="flex items-start justify-between">
                                            ...
                                            {s.specialization && <div className="text-xs text-slate-300 mt-1">{s.specialization}</div>}
                                        </div>
                                        {s.programs && <div className="text-xs text-slate-400"><strong>Programs:</strong> {s.programs}</div>}
                                    </div>
                                ))}
                            </div>
                        </div>
